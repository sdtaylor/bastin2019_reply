...
*Context* 
Bastin et al. 2019 use two flawed assumptions: 1) that the area suitable for restoration does not contain any carbon currently, and 2) that soil organic carbon (SOC) from increased canopy cover will accumulate quickly enough to mitigate anthropogenic carbon emissions. 
